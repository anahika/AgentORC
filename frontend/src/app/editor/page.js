...
import AgentModal from "./components/AgentModel";
...
const Editor = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div
        className={`flex flex-col bg-white p-4 transition-all duration-300  ${
      ...
      >
        ...
        <button
          ...
          className="mx-auto mt-auto text-white p-3 rounded-full bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl"
        >
          Submit
        </button>
      </div>

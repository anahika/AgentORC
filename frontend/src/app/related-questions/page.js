    ...
    <>
      {questions.length > 0 ? (
        <form
          ...
          style={{ maxWidth: "80vw", minHeight: "100vh" }}
        >
          <h3
            className="p-6 mb-8 bg-white shadow-lg rounded-lg text-white font-medium"
            style={{ background: "rgb(182, 142, 222)" }}
          >
            {query}
          </h3>
          <p
            className="animate-typing flex overflow-hidden whitespace-nowrap border-r-4 m-auto font-bold red-color"
